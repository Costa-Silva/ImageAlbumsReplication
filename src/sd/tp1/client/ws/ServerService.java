 ...
 * 
 */
@WebServiceClient(name = "ServerService", targetNamespace = "http://server.tp1.sd/", wsdlLocation = "http://localhost:8080/FileServer?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVERSERVICE_QNAME = new QName("http://server.tp1.sd/", "ServerService");
    ...
    public Server getServerPort() {
        return super.getPort(new QName("http://server.tp1.sd/", "ServerPort"), Server.class);
    }
    ...
    public Server getServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.tp1.sd/", "ServerPort"), Server.class, features);
    }
